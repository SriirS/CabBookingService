...
const API = {
  ...
  book: async(req, res) => {
    ...
    const result = tripsManager.createTrip(ridersManager.getRider(riderId), source, destination);
    res.status(result.err ? 500 : 200).json(result);    
  },
...
tripsManager.createTrip(rider1, new Location(0.0, 0.0), new Location(500.0, 500.0));
tripsManager.createTrip(rider2, new Location(0.0, 0.0), new Location(500.0, 500.0));
